...
const SafetyFeatures = () => {
  ...
  // Enhanced structured data for safety features
  const structuredData = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://back2nest.in/safety-features#service",
      ...
      {
        "@type": "WebPage",
        "@id": "https://back2nest.in/safety-features#webpage",
  ...
  const breadcrumbData = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Safety Features",
        "item": "https://back2nest.in/safety-features"
      }
    ]
  };
  ...
  return (
    <>
      <SEO 
        ...
        canonicalUrl="https://back2nest.in/safety-features"
        ...
        ogImage="https://back2nest.in/images/safety-features-og.jpg"
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
        ...
        <nav className="container mx-auto px-6 py-4" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li className="text-gray-800 font-medium">Safety Features</li>
          </ol>
        </nav>
          ...
          <main className="max-w-7xl mx-auto">
            ...
            <section className={`mb-16 transform transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl p-8 text-white">
                <h2 className="text-3xl font-bold text-center mb-8">Safety by the Numbers</h2>
            ...
            {/* Parent Safety App */}
            <section className={`mb-16 transform transition-all duration-1000 delay-1100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
