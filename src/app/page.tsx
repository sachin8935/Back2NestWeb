    ...
    <header className="bg-white shadow-md sticky top-0 z-50 border-b-2 border-blue-100">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="/reviews" className="text-gray-700 hover:text-blue-600 transition font-medium">
            Reviews
          </a>
          <a href="/products" className="text-gray-700 hover:text-blue-600 transition font-medium">
            Our Products
          </a>
        ...
        <div className="relative">
          <div className="relative bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 rounded-3xl p-3 shadow-2xl transform hover:rotate-1 transition duration-500">
            <Image
              ...
              alt="Fresh pure milk delivery Patna - Back2Nest farm to home milk service"
              width={700}
              height={700}
...
export default function Home() {
  return (
    <>
      {/* SEO Structured Data - Already in layout.tsx */}
