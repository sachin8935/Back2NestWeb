...
export const metadata: Metadata = {
  title: 'A2 Milk Delivery in Rajendra Nagar, Patna | Fresh by 5 AM Daily',
  description: 'Get pure A2 milk delivered to your doorstep in Rajendra Nagar by 5 AM. Fresh desi cow milk, ghee, paneer & dahi. Order now for same-day delivery in Rajendra Nagar, Patna.',
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                New customers in Rajendra Nagar get ₹50 off on their first order. Subscribe for daily 
                delivery and save up to 15% on your monthly milk bill. We also offer special discounts 
                during festivals and seasonal promotions. Refer a friend in Rajendra Nagar and both of you 
